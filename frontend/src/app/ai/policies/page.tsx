...
const DEMO_POLICIES: Policy[] = [
  {
    id: 'policy-hours',
    name: 'AI Working Hours Limit',
    description: 'AI employee can only run 8.30 am - 6pm GMT+8',
    natural_language: 'AI employee can only run 8.30 am - 6pm GMT+8',
    summary: 'Restrict AI employee execution to business hours in GMT+8.',
    policy_type: 'natural_language',
    dsl: null,
    refined_instruction: 'Restrict AI employee runs to 08:30 to 18:00 GMT+8.',
    ai_instruction: 'AI employee can only run 8.30 am - 6pm GMT+8',
    entity_name: 'ai_employee',
    is_active: true,
    priority: 10,
    tags: ['ai', 'hours', 'policy'],
    execution_count: 0,
  ...
  {
    id: 'policy-supplier',
    name: 'High Stakes Supplier Escalation',
    description: 'If the supplier ID = 3040, escalate to human approval as it is high stakes supplier',
    natural_language: 'If the supplier ID = 3040, escalate to human approval as it is high stakes supplier',
    summary: 'Escalate high-stakes supplier requests to human approval.',
    policy_type: 'natural_language',
    dsl: null,
    refined_instruction: 'If supplier ID equals 3040, escalate to human approval because it is a high-stakes supplier.',
    ai_instruction: 'If the supplier ID = 3040, escalate to human approval as it is high stakes supplier',
    entity_name: 'supplier',
    is_active: true,
    priority: 8,
    tags: ['supplier', 'approval', 'policy'],
    execution_count: 0,
    last_executed_at: null,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    name: 'Auto Approve Transactions Under 100K',
    description: 'Auto approve transactions less than 100K',
    natural_language: 'Auto approve transactions less than 100K',
    summary: 'Automatically approve low-value transactions below 100K.',
    policy_type: 'natural_language',
    dsl: null,
    refined_instruction: 'Auto approve transactions with a value less than 100K.',
    ai_instruction: 'Auto approve transactions less than 100K',
    entity_name: 'transaction',
    is_active: true,
    priority: 6,
    tags: ['transaction', 'approval', 'policy'],
    execution_count: 0,
    last_executed_at: null,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
